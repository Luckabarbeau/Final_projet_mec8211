function [T]=rad(m_dot_in,P,T,T_out,V_specific,Volume_rad,dt,vitesse,H_speed)
...
delta_t=T-(T_out+(T-T_out)*exp(-H/m_dot_in/energie_intern_liquide/1000*(V_specific*m_dot_in*dt)/Volume_rad));
T=T-delta_t;
if delta_t<0
    disp(delta_t);
end
